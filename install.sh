...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/debian"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="debian"
INSTDIR="$HOME/.local/share/dockermgr/debian"
APPDIR="$HOME/.local/share/srv/docker/debian"
DATADIR="$HOME/.local/share/srv/docker/debian/files"
...
HUB_URL="casjaysdevdocker/debian:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "debian"; then
